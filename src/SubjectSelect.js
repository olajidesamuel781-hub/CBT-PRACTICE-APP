  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-card">
        ...
        {/* Show trial and payment only if user is NOT premium */}
        {!isPremium && (
          <>
            {/* FREE TRIAL: only show if user hasn't used it */}
            {!trialUsed && (
              <button
            ...
            <PaystackButton
              ...
              className="primary-btn"
              onSuccess={(res) => verifyPayment(res?.reference)}
              onClose={() => {}}
            />
            ...
            return (
              <div
                ...
                className={`subject-item ${
                  String(subject).trim() === s ? "active-subject" : ""
                }`}
